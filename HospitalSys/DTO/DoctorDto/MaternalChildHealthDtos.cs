...
namespace HospitalSys.Dto.DoctorDtos
{
    ...
    public class ChildBirthDto
    {
        ...
        public string? ChildMRN { get; set; }
    ...
    public class CreateChildBirthDto
    {
        public int DeliveryID { get; set; }
        public int? ChildPatientID { get; set; }
        /// <summary>When ChildPatientID is null, supply names to register a new newborn Patient (MRN generated by backend).</summary>
    ...
    /// <summary>One registered child of a mother (via Delivery → ChildBirth → ChildPatient).</summary>
    public class MotherChildListItemDto
    {
        public int DeliveryID { get; set; }
        public int ChildBirthID { get; set; }
        public int ChildPatientID { get; set; }
        ...
        public string? BirthWeight { get; set; }
        public string? ApgarScore { get; set; }
        /// <summary>Most recent PatientVisit for this child, if any.</summary>
        public int? LatestVisitID { get; set; }
