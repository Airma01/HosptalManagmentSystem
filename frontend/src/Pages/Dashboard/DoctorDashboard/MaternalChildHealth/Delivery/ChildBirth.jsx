...
export default function ChildBirth() {
  ...
  return (
    <div className="space-y-4 max-w-3xl mx-auto">
      ...
      <div className="flex justify-between items-center"><h2 className="font-semibold">Child births · Delivery #{deliveryId}</h2>{canWrite && (
          <button type="button" onClick={() => setShow(true)} className="px-3 py-1.5 rounded-lg bg-rose-600 text-white text-xs">Add</button>
        )}</div>
